...
- **追踪模式**：
  ...
  - 靠近时震动；追踪期间屏幕常亮
- **🧭 方向罗盘（身体屏蔽法）**：手机平贴胸口、屏幕朝外，原地转一整圈。身体会挡住身后的信号，极坐标图上信号最强的扇区（绿色箭头）就是设备方向；白色小三角实时指示你面朝的方向，置信度会在多径反射产生多个强扇区时自动降低。
- **🗺 信号轨迹热力图**：像平时一样竖屏拿着手机走动，走过的路径按信号强弱染色（绿=最近）。走完回头一看，直奔绿色最深的那段路。
